    ...
    <div className={`bg-gradient-to-br ${bgColor} p-8 rounded-xl shadow-lg text-center group hover:shadow-xl transition-shadow hover-lift hover-tilt click-ripple smooth-transition`}>
      ...
      <div className="mt-4">
        <a 
          ...
          className="inline-flex items-center justify-center w-full px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-all duration-300 transform hover:scale-105 hover-glow"
        >

...
export default function WhatsAppButton() {
  ...
  return (
    <button
      ...
      className="whatsapp-button bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 hover-heartbeat click-ripple float-gentle"
